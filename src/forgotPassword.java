...
public class forgotPassword extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        getContentPane().add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(1299, 11, -1, 47));
        ...
        getContentPane().add(jButton2, new org.netbeans.lib.awtextra.AbsoluteConstraints(880, 280, -1, 20));

        jTextField2.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        getContentPane().add(jTextField2, new org.netbeans.lib.awtextra.AbsoluteConstraints(560, 320, 300, -1));

        jTextField3.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        getContentPane().add(jTextField3, new org.netbeans.lib.awtextra.AbsoluteConstraints(560, 360, 300, -1));
        ...
        getContentPane().add(jButton4, new org.netbeans.lib.awtextra.AbsoluteConstraints(640, 440, -1, -1));
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        else
        {
            ...
            try 
            {
                ...
                {
                    check = 1;
                    InsertUpdateDelete.setData("update users set password = '"+newPassword+"' where email = '"+email+"'", "Password set Sucessfuly");
                    setVisible(false);
                    new forgotPassword().setVisible(true);
//                    JOptionPane.showMessageDialog(null, "Bisa Mashook Pak eko");
                }
            } catch (Exception e) 
            {
                JOptionPane.showMessageDialog(null, e);
